...
**Client:** Remi
**Status:** DEPLOYED - Full Weather Dashboard + SMS/Email Alerts Live
**Version:** 2.1
...
Weather data extraction, visualization, and alert notification system for Martinique using Météo France API. Includes full weather dashboard and SMS/Email subscription system with Brevo integration.
